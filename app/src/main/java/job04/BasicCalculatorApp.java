...
public class BasicCalculatorApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Applying Scene to Main Window
        primaryStage.setScene(scene);
        primaryStage.show();   
    }

    // create a button with a specific text
    ...
    private void addDisplay(Stage primaryStage,GridPane gridPane) {
        ...
        Button saveVariableButton = createButton("Save ");
        ...
        // add the expresion to the list historic
        ...
        // update the ListView and the historic calcul
